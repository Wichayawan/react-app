...
function Register() {
    ...
    return (
      <>
        <div className="flex items-center justify-center min-h-screen bg-pink-100"> {/* พื้นหลังสีชมพูอ่อนแบบมินิมอล */}
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="p-8 bg-white mt-6 rounded-lg shadow-md">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="w-full p-3 mt-4 bg-pink-500 text-white rounded hover:bg-pink-600">
                  Register
                </button>
