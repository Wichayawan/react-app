...
function Account() {
    ...
    return (
        <>
            <h1>Account</h1>
            <div className="p-6 bg-pink-100 rounded-lg shadow-md max-w-md mx-auto"> {/* พื้นหลังสีชมพูอ่อน */}
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className="px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-300 transition-all"
                    >
                        แก้ไขข้อมูล
                    </button>
                </div>
